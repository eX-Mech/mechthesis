...
\info{% Defence information (in swedish)
	...
	av teknologie
	\change{doktorsexamen} % doctorsexamen/licentiatsexamen
	\change{s\"{o}ndagen den 30 Februari 3641 kl 23:30} % day
	...
	%
	TRITA-MEK Technical report \change{3641:01}\\
	ISSN \change{0348-467X}\\
	ISRN \change{KTH/MEK/TR-41/01-SE}\\
	ISBN \change{978-91-7942-634-9}
	%
